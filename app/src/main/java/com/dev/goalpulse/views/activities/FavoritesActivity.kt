...
import com.dev.goalpulse.databinding.ActivityFavoritesBinding
...
import com.dev.goalpulse.viewModels.FavoritesActivityViewModel
import com.dev.goalpulse.viewModels.MyViewModelProvider
import com.dev.goalpulse.views.adapters.footballAdapters.CarouselRecyclerViewAdapter
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                if(leagues.isNotEmpty()) {
                    ...
                    favoritesActivityBinding.leaguesError.errorText.text = this@FavoritesActivity.resources.getString(
                        R.string.no_results)
