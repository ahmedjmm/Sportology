...
class NewsViewModel @Inject constructor(
    ...
    suspend fun getEveryThingNews() = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            if(response?.body()?.articles?.isEmpty()!!)
                _everyThingMutableLiveData.postValue(ResponseState.Error(application.resources.getString(
                    R.string.no_results)))
            else
    ...
    suspend fun getTopHeadlinesNews() = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            if(response?.body()?.articles?.isEmpty()!!)
                _topHeadlinesMutableLiveData.postValue(ResponseState.Error(application.resources.getString(
                    R.string.no_results)))
            else
