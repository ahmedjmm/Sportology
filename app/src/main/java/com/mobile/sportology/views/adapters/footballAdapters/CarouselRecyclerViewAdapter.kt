...
import com.mobile.sportology.databinding.FavouriteItemBinding
...
//            itemView.item_winner.text = league.country
        ...
        fun bindTeam(team: TeamRoom, position: Int) {
    ...
    override fun onBindViewHolder(holder: CarouselViewHolder, position: Int) {
        if (favourites[position] is LeagueRoom)
            ...
            holder.bindTeam(favourites[position] as TeamRoom, position)
    }
}